...
public class Kingsman_Frame extends JFrame {
	private Assento[] Lugares = new Assento[50];
	private KingsmanControl c = new KingsmanControl();
	
	public Kingsman_Frame (String nome, int id_user) {
		super(nome);
	...
	private void ValidarIngressos(Assento[] Lugares) {
		KingsmanControl novo = new KingsmanControl ();
