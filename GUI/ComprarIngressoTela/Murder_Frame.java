...
public class Murder_Frame extends JFrame {
	private Assento[] Lugares = new Assento[50];
	private MurderControl c = new MurderControl();
	
	public Murder_Frame (String nome, int id_user) {
		super(nome);
	...
	private void ValidarIngressos(Assento[] Lugares) {
		MurderControl novo = new MurderControl ();
