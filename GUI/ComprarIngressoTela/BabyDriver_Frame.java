...
public class BabyDriver_Frame extends JFrame {
	private Assento[] Lugares = new Assento[50];
	private BabyDriverControl c = new BabyDriverControl();
	
	public BabyDriver_Frame(String nome, int id_user) {
		super(nome);
	...
	private void ValidarIngressos(Assento[] Lugares) {
		BabyDriverControl novo = new BabyDriverControl ();
