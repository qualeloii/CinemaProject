...
public class AtomicBlond_Frame extends JFrame {
	private Assento[] Lugares = new Assento[50];
	private AtomicControl c = new AtomicControl();
	
	public AtomicBlond_Frame(String nome, int id_user) {
		super(nome);
	...
	private void ValidarIngressos(Assento[] Lugares) {
		AtomicControl novo = new AtomicControl ();
