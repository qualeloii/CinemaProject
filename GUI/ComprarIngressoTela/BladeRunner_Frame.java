...
public class BladeRunner_Frame extends JFrame {
	private Assento[] Lugares = new Assento[50];
	private BladeRunnerControl c = new BladeRunnerControl();
	
	public BladeRunner_Frame (String nome, int id_user) {
		super(nome);
	...
	private void ValidarIngressos(Assento[] Lugares) {
		BladeRunnerControl novo = new BladeRunnerControl ();
