...
public class GuardiansGalaxy_Frame extends JFrame {
	private Assento[] Lugares = new Assento[50];
	private GuardiansGalaxyControl c = new GuardiansGalaxyControl();
	
	public GuardiansGalaxy_Frame (String nome, int id_user) {
		super(nome);
	...
	private void ValidarIngressos(Assento[] Lugares) {
		GuardiansGalaxyControl novo = new GuardiansGalaxyControl ();
